...
class ActionPub(Node):
    def __init__(self, action_frames):
        ...
        self.left_gripper_pub = self.create_publisher(Float64, "/left_gripper_controller", 10)
        self.right_gripper_pub = self.create_publisher(Float64, "/right_gripper_controller", 10)
